//
//  UssdPaymentDetailsPresenter.swift
//  MonnifyiOSSDK
//
...
protocol UssdPaymentDetailsPresenterProtocol : BaseActivePresenterProtocol {
    
    func startCopyPressedTimer()

}

class UssdPaymentDetailsPresenter: BaseActivePresenter  {
    
    private weak var view: UssdPaymentDetailsViewDelegate?
    ...
    required init(view: UssdPaymentDetailsViewDelegate,
...
extension UssdPaymentDetailsPresenter : UssdPaymentDetailsPresenterProtocol {
